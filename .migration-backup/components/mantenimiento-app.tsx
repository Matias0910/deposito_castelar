...
<<<<<<< HEAD:components/mantenimiento-app.tsx
      <div className="flex items-center justify-end gap-2 print:hidden mt-4">
        <Button variant="outline" onClick={() => {
            if (window.confirm(`¿Borrar los datos cargados del Equipo ${equipo} (${planilla.nombre})?`)) reset()
        }}>
            <RotateCcw className="mr-2 size-4" /> Resetear
        </Button>
        <Button onClick={() => alert("Funcionalidad para generar y enviar PDF pendiente de implementación.")}>
...
=======
>>>>>>> 2691dbf9d0327f3974e711085808aa881363fcc6:.migration-backup/components/mantenimiento-app.tsx
