  ...
  return (
    <div className="bg-background p-4 sm:p-6 rounded-lg shadow-sm border border-border max-w-7xl mx-auto text-xs font-sans mt-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4 border-b border-border pb-3 text-sm">
        ...
        <div>
          <span className="font-bold">FECHA Y HORA DE INICIO:</span> {header.fechaIngreso ? new Date(header.fechaIngreso).toLocaleString() : "_________________"}
        </div>
        <div>
          <span className="font-bold">FECHA Y HORA DE FINALIZACIÓN:</span> {header.fechaEgreso ? new Date(header.fechaEgreso).toLocaleString() : "_________________"}
        </div>
        <div>
...
<<<<<<< HEAD:components/planilla-anexo-observaciones.tsx
}
=======
}
>>>>>>> 2691dbf9d0327f3974e711085808aa881363fcc6:.migration-backup/components/planilla-anexo-observaciones.tsx
